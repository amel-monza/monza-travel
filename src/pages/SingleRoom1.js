...
import StyledMero1 from '../components/StyledMero1';
...
export default class SingleRoom1 extends Component{
    constructor(props) {
        super(props);
        this.state ={
    ...
    static contextType = RoomContext1;
    render () {
        ...
        const {name,description,Bar,Resturant,Pool,location,price,extras,wifi,images,description1} = room;
        const [mainImg,...defaultImg] = images;
       

    return (
    <>
    <StyledMero1 img={mainImg || this.state.defaultBcg}>
        
        <Banner title={`${name}`}>
            <Link to='/wintervacations' className="btn-primary">
                back to rooms
            </Link>
        </Banner>
    </StyledMero1>
