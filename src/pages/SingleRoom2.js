...
import StyledMero2 from '../components/StyledMero2';
...
export default class SingleRoom2 extends Component{
    ...
    static contextType = RoomContext2;
    render () {
    ...
    return (
    <>
    <StyledMero2 img={mainImg || this.state.defaultBcg}>
        
        <Banner title={`${name}`}>
            <Link to='/luxurycruise' className="btn-primary">
                back to rooms
            </Link>
        </Banner>
    </StyledMero2>
